      ...
      >
        <Stack flex={1} spacing={{ base: 5, md: 10 }}>
          ...
          <Text color={"gray.500"}>
            ...
            tempore minima modi, ut id, distinctio ex reprehenderit facere
            pariatur incidunt libero provident adipisci expedita cupiditate
            debitis alias a voluptatibus hic.
          </Text>
          <Stack
            spacing={{ base: 4, sm: 6 }}
